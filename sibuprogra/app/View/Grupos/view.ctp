...
<h2><?php  echo __('Grupo'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($grupo['Grupo']['fec_reg']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link($this->Html->image('edit.png'), array('action' => 'edit', $grupo['Grupo']['id']),array('escape'=>FALSE,'title'=>'Editar')); ?> </li>
		<li><?php echo $this->Form->postLink($this->Html->image('delete.png'), array('action' => 'delete', $grupo['Grupo']['id']), array('escape'=>FALSE,'title'=>'Eliminar'), __('Seguro desea eliminar # %s?', $grupo['Grupo']['id'])); ?> </li>
	</ul>
</div>
